    ...
    <>
      <div className="container mx-auto flex flex-col items-center h-screen">
        <div className="md:w-full w-[90%] bg-gray-100 rounded-full px-5 py-2 my-2 mx-5 flex justify-between items-center">
          <Link href="dashboard" className="text-2xl font-bold  px-5 py-2">
            Lettr.
          </Link>
            ...
            {menuOpen && (
              <div className="absolute w-[200px] right-0 mt-2 bg-white border rounded-md shadow-lg z-10">
                ...
                <button
                  ...
                  className="block px-5 py-2 text-left hover:bg-gray-200"
                >
                  Logout
                </button>
              </div>
          ...
          <div className="hidden md:flex gap-4">
            <Link href="/dashboard" className="underline text-black pe-5">
              All Letters
            </Link>
            <button
              onClick={handleLogout}
              className="underline text-black pe-5"
            >
              Logout
            </button>
          </div>
        ...
        <form
          ...
          className="flex flex-col items-center md:w-full max-w-md p-6 mt-[7em] md:mt-[8em] bg-white rounded-xl shadow-md mx-2"
        >
          ...
          <button
            type="submit"
            className="bg-blue-200 px-5 py-2 w-[50%] rounded-3xl mx-auto"
          >
            Add Letter
          </button>
        </form>
